...
historical makes and rust crosses for misses. After shows hypothetical relocations as
cyan diamonds and marks their origins with faint rings. Modeled Ability shows the full
heatmap with one fixed probability scale and supported destinations.
